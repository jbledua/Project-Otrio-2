...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Project-Otrio", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Project-Otrio", null, 1280, 720);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Project-Otrio";
		app.meta["name"] = "Project-Otrio";
